...
public class Fichero {
	...
	/**
	 * Busca todos los ficheros que cumplen la máscara que se le pasa y los mete en
	 * la listaFicheros que se le pasa.
	 *
	 * @param pathInicial
	 *            Path inicial de búsqueda. Debe ser un directorio que exista y con
	 *            permisos de lectura.
	 * @param mascara
	 *            Una máscara válida para la clase Pattern de java.
	 * @param listaFicheros
	 *            Una lista de ficheros a la que se añadirán los File que cumplan la
	 *            máscara. No puede ser null. El método no la vacía.
	 * @param busquedaRecursiva
	 *            Si la búsqueda debe ser recursiva en todos los subdirectorios por
	 *            debajo del pathInicial.
	 */
	...
	/**
	 * Se le pasa una máscara de fichero típica de ficheros con * e ? y devuelve la
	 * cadena regex que entiende la clase Pattern.
	 * 
	 * @param mascara

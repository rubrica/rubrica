 ...
 */
public class CertificadoFuncionarioPublicoSecurityDataOld extends CertificadoSecurityDataOld
		implements CertificadoFuncionarioPublico {

	public CertificadoFuncionarioPublicoSecurityDataOld(X509Certificate certificado) {
		super(certificado);
	}

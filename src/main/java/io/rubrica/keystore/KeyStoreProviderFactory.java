...
public class KeyStoreProviderFactory {
	...
	static {
		...
		linux.add(new ETokenProKeyStoreProvider());
		linux.add(new Bit4idStoreProvider());
		linux.add(new EPass2003KeyStoreProvider());
		linux.add(new EPass3003KeyStoreProvider());

 ...
 * @author Modificado , Jorge Ruales <jorge.ruales@presidencia.gov.ec>
 */
public class WindowsKeyStoreProvider_iKey implements KeyStoreProvider {

	private static String windowsDir_iKey = "name = SmartCard\nlibrary = " + System.getenv("WINDIR")
	...
	private static final Logger logger = Logger.getLogger(WindowsKeyStoreProvider_iKey.class.getName());
	...
	public KeyStore getKeystore(char[] password) throws KeyStoreException {
		try {
			...
			aprov.setCallbackHandler(new SimpleCallbackHandler(null, password));
